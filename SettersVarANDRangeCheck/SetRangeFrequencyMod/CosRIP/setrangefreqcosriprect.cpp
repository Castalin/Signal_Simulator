#include "setrangefreqcosriprect.h"

SetRangeFreqCosRIPRect::SetRangeFreqCosRIPRect(SignalVariables * const signalVariables, ModSignalVariables * const modSignalVariables)
    : A_signal{signalVariables}, A_signalMod{modSignalVariables}
{

}

double SetRangeFreqCosRIPRect::setRangeFrequency() const
{
