...
void ControlDataMain::slot_processingAddress(const QByteArray receivedMessage)
{
    ...
    switch (m_address) {
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::CONTROL)), receivedMessage.at(1));
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_A_DELAY_0)), receivedMessage.at(1));
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_A_DELAY_1)), receivedMessage.at(1));
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_B_DELAY_0)), receivedMessage.at(1));
        ...
        case GreenBoardAddressBytes::ADC_B_DELAY_1:
        {
            ...
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_B_DELAY_1)), receivedMessage.at(1));
        ...
        {
            //m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_CONTROLWORD_0)), receivedMessage.at(1));
        ...
        {
            //m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::ADC_CONTROLWORD_1)), receivedMessage.at(1));
            //emit signal_controlSettingsOne(receivedMessage[1]);
            break;
        }
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::CONTROL2)), receivedMessage.at(1));
        ...
        {
            m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::LED)), receivedMessage.at(1));
        ...
        {
            //m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::SPI_BYTE_0)), receivedMessage.at(1));
            //emit signal_controlSettingsOne(receivedMessage[1]);
            break;
        }
        ...
        {
            //m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::SPI_BYTE_1)), receivedMessage.at(1));
            //emit signal_controlSettingsOne(receivedMessage[1]);
            break;
        }
        ...
        {
            //m_condition->insert((17 + 2 * static_cast<quint16>(GreenBoardAddressBytes::SPI_BYTE_2)), receivedMessage.at(1));
            //emit signal_controlSettingsOne(receivedMessage[1]);
            break;
        }
    }
